...
Production Pages и production D1 в ходе этой подготовки не разворачивались и не изменялись. Были изменены только безопасные Cloudflare-настройки до deployment: R2 custom domain, production Pages R2 binding/base и управление автоматическими deployments/hooks. Preview D1/Pages и staff roles были подготовлены ранее на SHA `2e165736…`; image-policy изменения опубликованы в `d1-preview-bootstrap` и draft PR #2, поэтому следующий preview обязан использовать новый SHA.
