...
export function PhShape({kind}){
  ...
  if(kind==="bit"||kind==="tool") return <div style={wrap}><svg width="48%" viewBox="0 0 120 40"><rect x="4" y="17" width="78" height="6" rx="3" fill={c}/><path d="M82 8l30 12-30 12z" fill={d}/></svg></div>;
